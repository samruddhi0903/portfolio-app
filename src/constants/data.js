...
export const PROFILE_DATA = {
    ...
    executiveSummary: `I am a frontend-first software engineer with 3+ years of experience building and evolving complex web systems used in production. My work spans enterprise SaaS platforms and end-to-end freelance products, where I’ve owned frontend architecture, modernized legacy UIs, optimized performance, and built multi-role user journeys using React, TypeScript, and Angular. I’ve contributed to large-scale products at Coupa and Keurig, worked on accessibility-compliant interfaces, and delivered full-stack systems for real businesses. Beyond traditional frontend development, I explore AI-driven execution and automation by designing agent-based workflows with LLMs and n8n to better understand dependency management, orchestration, and decision gating in modern products. I value clarity, ownership, and systems thinking, and I enjoy working on products where frontend decisions directly shape usability and scale.`,
